...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.clear_btn.setGeometry(QtCore.QRect(50, 390, 151, 32))
        ...
        self.label_2.setGeometry(QtCore.QRect(50, 270, 58, 16))
        self.label_2.setObjectName("label_2")
        self.file_box = QtWidgets.QTextBrowser(self.centralwidget)
        self.file_box.setGeometry(QtCore.QRect(50, 300, 301, 26))
        self.file_box.setObjectName("file_box")
        self.send_btn = QtWidgets.QPushButton(self.centralwidget)
        self.send_btn.setGeometry(QtCore.QRect(200, 390, 151, 32))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.file_box.setPlaceholderText(_translate("MainWindow", "Drag file here to send..."))
